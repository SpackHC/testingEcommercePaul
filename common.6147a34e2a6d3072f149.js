(() => {
  ...
  var r = {
        ...
        function t(r, t) {
          for (var A = {}, i = [], a = 0; a < r.length; a++) {
            ...
            if (-1 !== d) n[d].references++, n[d].updater(m);
              ...
              var g = o(m, t);
              (t.byIndex = a),
                n.splice(a, 0, { identifier: C, updater: g, references: 1 });
            }
            i.push(C);
          }
          return i;
      ...
      946: (r, n, e) => {
        r.exports = e.p + "image/cartIcon.png";
      },
    },
    n = {};
  function e(t) {
  ...
  (e.m = r),
    ...
    (() => {
      ...
      const u = e.p + "image/logoText.png",
        p = e.p + "image/logoTextTransparent.png",
        h = e.p + "image/burgerOpen.png",
        f = e.p + "image/burgerClose.png",
        b = e.p + "image/magnifyingGlassWhite.png",
        B = e.p + "image/redditIcon.png",
        y = e.p + "image/twitterIcon.png",
        E = e.p + "image/facebookIcon.png",
        k = e.p + "image/instagramIcon.png";
      (document.getElementById("mobile-nav-logo").src = u),
        (document.getElementById("nav-logo").src = p);
      var v = document.getElementById("open-icon");
      (v.src = h), (document.getElementById("close-icon").src = f);
      var x = document.getElementById("close-burger-btn");
      document
        .getElementById("open-burger-btn")
        .addEventListener("click", function () {
          var r = document.getElementById("burger-menu");
        ...
        (document.getElementById("searchIcon").src = b),
        (document.getElementById("redditIcon").src = B),
        (document.getElementById("twitterIcon").src = y),
        (document.getElementById("facebookIcon").src = E),
        (document.getElementById("instagramIcon").src = k);
    })();
})();
//# sourceMappingURL=common.6147a34e2a6d3072f149.js.map
